const projects = [
  {
    ...
    files: [
      { name: "Optumus Suite Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Optumus Suite Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Optumus Suite Logo.Zip", size: "2.02 MB", link: "#" },
      { name: "Boottheme admin.Zip", size: "2.25 MB", link: "#" },
    ],
    comments: [
      {
        id: 1,
  ...
  },
  {
    id: 4,
    img: "img5",
    name: "Optumus Suite Dashboard UI",
